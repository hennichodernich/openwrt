...
define Device/ausek_cp-0085-8meg
  LOADER_TYPE := gz
  KERNEL := kernel-bin | append-dtb | lzma
  KERNEL_INITRAMFS := kernel-bin | append-dtb | lzma 
  IMAGES += factory.bin
  ...
  DEVICE_VENDOR := Ausek
  SOC := tp9343
  DEVICE_MODEL := CP-0085 8M Upgrade
  SUPPORTED_DEVICES += ausek_cp-0085-8meg
endef
TARGET_DEVICES += ausek_cp-0085-8meg
...
define Device/ausek_cp-0085-16meg
  ...
  DEVICE_VENDOR := Ausek
  SOC := tp9343
  DEVICE_MODEL := CP-0085 16M Upgrade
